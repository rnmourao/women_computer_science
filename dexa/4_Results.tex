...
The association rule mining resulted in 1,171 rules involving the students' interest in Computer Science. Rules with lift less than 50\% were excluded, remaining only ten rules. Figure \ref{fig:apriori} shows rules' left-hand side (LHS), rules' right-hand side (RHS), support, confidence and lift metrics.
...
\begin{figure}%
\includegraphics[width=\textwidth]{img/{freq.Family.Approval}.pdf}%
\caption{Amount of respondents by answer in Family.Approval and in CS.Interest.}%
\label{fig:freq.Family.Approval}%
\end{figure}%

Other attributes shown in Figure \ref{fig:apriori} had significance lowered, as Computer.Work and Use.Creativity, as shown in figures \ref{fig:plot.Computer.Digital.Inclusion.Centre}~\ref{fig:plot.Computer.Home}~\ref{fig:plot.Computer.Lan.House}~\ref{fig:plot.Use.Internet}~\ref{fig:plot.Use.Social.Network}~\ref{fig:plot.Use.Text.Editor}. 
