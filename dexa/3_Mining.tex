...
% ANOVA %%%%%%%%%%%
An analysis of variance test was applied to the data, \gnramos{using the command \texttt{anova}}, creating a table which tests whether the model terms are significant~\cite{Chambers1990}.
